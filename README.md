...
* Run the app on the server: Go to the [*ForecastR* App](https://solv-code.shinyapps.io/forecastr/), load in a data file, and explore the alternative forecast models.
