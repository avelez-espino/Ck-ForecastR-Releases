...
* Run the app locally: Download a [zip folder](Zipped_Releases/CK_ForecastR_Prototype2019_03_11.zip) (Open this link in a new tab, then click the *Download* button),
