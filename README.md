...
* Run the app locally: Download a [zip folder](Zipped_Releases/https://github.com/avelez-espino/Ck-ForecastR-Releases/blob/master/Zipped_Releases/CK_ForecastR_prototype2019_03_11.zip) (Open this link in a new tab, then click the *Download* button),
